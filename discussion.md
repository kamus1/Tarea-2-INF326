...
## BONUS
Para asegurar la unicidad de los id de los registros se pueden utilizar identificadores con offsets unicos por nodos, es decir: id = offset_inicial + offset_nodo + (contador_local * salto)
